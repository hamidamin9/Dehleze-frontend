...
function DeliveredOrders({ orderStats, activeTab, orders = [], products = [], userData }) {
    return (
        <>
            {activeTab === 6 && (
                <div className="processing-orders">
                    ...
                    {orders.length === 0 ? (
                        <p className="no-orders-message">No delivered orders found.</p>
                    ) : (
                        <ul className="orders-list">
                            {orders
                                ...
                                .sort((a, b) => new Date(b.placed_at) - new Date(a.placed_at)) // Sorting orders by "placed_at"
                                .map((order) => {
